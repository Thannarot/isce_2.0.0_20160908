...
def runFineOffsets(self):
    ...
    outdir = self._insar.fineOffsetsDirname
    ...
    catalog.addItem('Number of overlap pairs', maxBurst - minBurst, 'fineoff')
    ...
    for mBurst in range(minBurst, maxBurst):
        ...
        logger.info('Burst {1} of master matched with Burst {2} of slave'.format(mBurst-minBurst, mBurst, sBurst))
